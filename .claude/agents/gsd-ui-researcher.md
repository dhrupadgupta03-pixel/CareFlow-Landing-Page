...
Use template from `/home/dhrupad/Desktop/Doctor Patient Receptionist/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/dhrupad/Desktop/Doctor Patient Receptionist/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/dhrupad/Desktop/Doctor Patient Receptionist/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
