...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/dhrupad/Desktop/Doctor Patient Receptionist/.claude
                  → checks /home/dhrupad/Desktop/Doctor Patient Receptionist/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/dhrupad/Desktop/Doctor Patient Receptionist/.claude/get-shit-done
                  → writes to /home/dhrupad/Desktop/Doctor Patient Receptionist/.claude/get-shit-done/hooks/
...
@/home/dhrupad/Desktop/Doctor Patient Receptionist/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/dhrupad/Desktop/Doctor Patient Receptionist/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/home/dhrupad/Desktop/Doctor Patient Receptionist/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/dhrupad/Desktop/Doctor Patient Receptionist/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/dhrupad/Desktop/Doctor Patient Receptionist/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
